    ...
    <>
      ...
      <Section title="Инкотермс (условия поставки)">
        ...
        <UL>
          ...
          <li>
            <b>CFR, CIF, CPT, CIP</b> — доставка уже в цене. Отдельно заданный фрахт грозит{' '}
            <b>двойным счётом</b>.
          </li>
          <li>
            <b>DAP, DPU, DDP</b> — доставка до места в РФ включена в цену, поэтому фрахт не добавляют,
            но перевозку по России после границы (а при <b>DDP</b> — ещё ввозные пошлины и НДС) в
            таможенную стоимость <b>не включают</b> — при документальном выделении их вычитают.
          </li>
