 ...
 * Используется для backfill и для @Internal-контуров без actor (напр. discovery-агент):
 * пока провайдер один — все его лиды идут сюда. При втором провайдере контур агента
 * придётся параметризовать компанией.
 */
