...
import { VisionRetry } from './vision-retry';
...
export class ClassifierService {
  ...
  private visionRetry: VisionRetry;
  ...
  constructor(
    ...
    @Optional() @Inject(PhotoStorageService) photoStorage: PhotoStorageService | null = null,
  ) {
    this.visionRetry = new VisionRetry(tksApi, anthropic, aiConfig, audit, photoStorage);
  }
