...
# Загрузка файла
upload-via-attachment = Прикрепите файл (.xlsx или .csv) через скрепку 📎 — отдельная кнопка больше не нужна.
...
row-clarify-input-text-placeholder = материал, размер, назначение, применение
row-clarify-input-code-prompt = Введите 10-значный код ТН ВЭД для позиции #{ $row }.
row-clarify-input-code-placeholder = 10 цифр кода ТН ВЭД
